...
public class CreditPage {
    ...
    private SelenideElement fieldMonth = $("[placeholder='02']");
    private SelenideElement fieldYear = $("[placeholder='26']");
    private SelenideElement fieldOwner = $$("[class='input__control']").get(3);
    private SelenideElement fieldCvc = $("[placeholder='111']");
    ...
    private SelenideElement bankRefusal = $(withText("Банк отказал в проведении операции."));
    ...
    public void expectApprovalFromBank() {
        bankApproved.shouldBe(visible, Duration.ofSeconds(10));
    }

    public void expectRejectionFromBank() {
        bankRefusal.shouldBe(visible, Duration.ofSeconds(10));
    }
